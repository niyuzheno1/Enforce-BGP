...
export default function WithdrawRouteLengthGraph() {
  const value = React.useContext(WithdrawnContext);
  useEffect(() => {
    var margin = { top: 10, right: 30, bottom: 30, left: 30 },
      width = 360 - margin.left - margin.right,
      height = 400 - margin.top - margin.bottom;
    select("#withdrawroutelength").selectAll("*").remove();
    ...
    var svg = select("#withdrawroutelength")
      .append("svg")
  ...
  return <div id="withdrawroutelength"></div>;
}
